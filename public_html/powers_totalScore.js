...
function totalScore(){
    ...
    total_score = parseInt(coin_score) + Math.round(parseInt(time)/2) + parseInt(invin_count)*3 + parseInt(invin_used)*10 + parseInt(boost_count)*2 + parseInt(boost_used)*5 + pps + Math.round(player.dist/500);
    ...
    document.getElementById("t_dist").innerHTML = Math.round(player.dist/500);
